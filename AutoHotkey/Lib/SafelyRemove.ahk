;based on https://autohotkey.com/board/topic/41310-safelyremoveums-safely-remove-usb-mass-storage-drives/
;and      AutoHotkey Forum Topic :  http://www.autohotkey.com/community/viewtopic.php?t=44873
SafelyRemove( DrivePath, ForceNonUMS=0 ) { ; based on SafelyRemoveUMS v1.01 by SKAN,   CD:01-Sep-2012 / LM:09-Sep-2014
 ...
 If ( hvol < 1 )
    Throw Exception("Unable to access volume!",, DrivePath)
 ...
 NumPut( StorageDeviceProperty := 0, pSTORAGE_PROPERTY_QUERY + 0 )
    ...
    If (!ForceNonUMS) {
        ...
        If ( BT <> 0x7 )                                  ; BusTypeUsb = 0x7
           Throw Exception("Drive is not an USB Mass Storage Device!")
 ...
 If ( BR = 0 )
    Throw Exception("Unable to ascertain the Device number")
 ...
 If ( hDevInfo < 1 )
    Throw Exception("No storage class devices were found!")
 ...
 If ( DeviceFound = 0 )
    Throw Exception("No matching storage class devices found!")
 ...
 If ( hDeviceID = 0 )
    Throw Exception("Cannot find device's parent")
