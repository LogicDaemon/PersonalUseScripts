...
rem     CALL "%baseScripts%\_DistDownload.cmd" https://update.vivaldi.com/update/1.0/public/appcast.xml *.exe -ml1 -A.exe -nd "-e robots=off" -HD downloads.vivaldi.com,vivaldi.com
    START "" /WAIT /B py "%baseScripts%\download_appcast.py" https://update.vivaldi.com/update/1.0/public/appcast.x64.xml
    START "" /WAIT /B py "%baseScripts%\download_appcast.py" https://update.vivaldi.com/update/1.0/public/appcast.xml
)
