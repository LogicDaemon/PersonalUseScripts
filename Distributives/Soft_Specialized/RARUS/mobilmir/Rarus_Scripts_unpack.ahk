...
RunWait "%exe7z%" x -aoa -o"%A_AppDataCommon%\mobilmir.ru" -- "%A_ScriptDir%\Rarus_Scripts.7z"

MsgBox "%exe7z%" x -aoa -o"%A_AppDataCommon%\mobilmir.ru" -- "%A_ScriptDir%\Rarus_Scripts.7z"`nResult: %ERRORLEVEL%
