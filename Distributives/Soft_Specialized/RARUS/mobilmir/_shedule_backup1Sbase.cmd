...
"%SystemRoot%\System32\schtasks.exe" /Create /TN "mobilmir\backup_1S_base" /XML "%~dp0Tasks\backup_1S_base.xml" /F
EXIT /B

:XP
(
    %exe7z% x -o"%SystemRoot%\Tasks" "%srcpath%Tasks.7z" backup_1S_base.job
