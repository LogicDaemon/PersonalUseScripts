...
CALL "%~dp0_DistDownload.cmd" "http://sourceforge.net/projects/%~1/files/latest/download" %2 -m -l 1 -A "%~x2" -nd -H -D downloads.sourceforge.net -e "robots=off" -p --user-agent="Mozilla/5.0 (Windows NT 10.0; Win64; x64)"
