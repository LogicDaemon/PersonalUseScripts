...
@(
    ...
    SET "dstrename=FastPictureViewer_x32_x64.zip"
    CALL "%baseScripts%\_DistDownload.cmd" http://www.fastpictureviewer.com/bin/FastPictureViewer_x32_x64.zip FastPictureViewer_x32_x64.zip* -N
)
