...
set sitename=wirusy.antivirenkit.pl
set othersitenames=www.gdata.pl
set URL=http://wirusy.antivirenkit.pl/en/szczepionki/
...
start "Downloading %sitename%" /wait /D"%~dp0" wget.exe -w 5 --random-wait --waitretry=300 -N -w 0 --progress=bar -rH -x -E -e robots=off -k -K -p -D %sitename%,%othersitenames% -np %URL%
