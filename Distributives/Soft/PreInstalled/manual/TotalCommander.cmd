...
CALL :FindAutoHotkeyExe || (CALL "%~dp0..\..\Keyboard Tools\AutoHotkey\install_silently.cmd" & CALL :FindAutoHotkeyExe)
)
...
:Unpack7ZipLibs
(
    "%utilsdir%7za.exe" x -r -aoa -o"%TCDir%\PlugIns\wcx\Total7zip" -- "%~dp0..\..\Archivers Packers\7Zip\d.7-zip.org\a\7z*.exe" Lang\* 7z.dll 7z.sfx 7zg.exe
)
:Skip7z
(
