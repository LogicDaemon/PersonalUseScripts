...
IF NOT DEFINED PrimaryDestination (
    IF %AutoHotkey_Lib_reentrance% GEQ 2 EXIT /B 1
    SET /A AutoHotkey_Lib_reentrance+=1
    CALL "%~dp0..\..\Keyboard Tools\AutoHotkey\install_silently.cmd"
    ...
    "%utilsdir%7za.exe" x -r -aoa -o"%PrimaryDestination%" -- "%srcpath%%~n0.7z"
)
