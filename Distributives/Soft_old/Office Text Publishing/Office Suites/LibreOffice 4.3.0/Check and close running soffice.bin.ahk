...
Loop
{
	...
	If (RunInteractiveInstalls!=0) {
		...
		Run "%A_WinDir%\System32\shutdown.exe" /r /t %shutdowntime% /c "Требуется закрыть %appname%. За 10 секунд до перезагрузки процесс %binaryname% будет остановлен`, и перезагрузка не произойдёт`, но не сохранённые изменения документов будут утеряны."
