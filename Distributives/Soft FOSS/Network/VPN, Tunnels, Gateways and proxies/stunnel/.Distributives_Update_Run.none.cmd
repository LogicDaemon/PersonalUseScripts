...
(
    CALL "%baseScripts%\_DistDownload.cmd" https://www.stunnel.org/downloads.html -win64-installer.exe -ml1 -nd -A.exe
    CALL "%baseScripts%\_DistDownload.cmd" https://www.stunnel.org/downloads.html -win64-installer.exe.asc -ml1 -nd -A.exe.asc
    CALL "%baseScripts%\_DistDownload.cmd" https://www.stunnel.org/downloads.html -win64-installer.exe.sha256 -ml1 -nd -A.exe.sha256
