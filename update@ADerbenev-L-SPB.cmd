...
robocopy "%LOCALAPPDATA%\Scripts" "%~dp0misc" /MIR /S /XD .mypy_cache .venv connect-asg-host helper_shortcuts Photo temp-backup-scripts /XF Hotkeys_Custom.ahk Hotkeys_Custom.*.ahk *.lnk _Distributives.base_dirs.txt aws_s.cmd aws_t.cmd
