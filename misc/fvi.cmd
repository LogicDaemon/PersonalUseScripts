...
REM This work is licensed under a Creative Commons Attribution-ShareAlike 4.0 International License <http://creativecommons.org/licenses/by-sa/4.0/deed.ru>.
    ...
    IF EXIST "%LOCALAPPDATA%\Programs\FreeVimager\FreeVimager-Portable.exe" (
        START "" /B "%LOCALAPPDATA%\Programs\FreeVimager\FreeVimager-Portable.exe" %*
        EXIT /B
    ) ELSE IF EXIST "%LOCALAPPDATA%\Programs\FreeVimager\FreeVimager.exe" (
