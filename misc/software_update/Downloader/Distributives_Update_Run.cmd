...
FOR /R "%baseDistributives%" %%I IN (".Distributives_Update_Run.All.*" ".Distributives_Update_Run.Office.*") DO START /B %comspec% /C ""%~dp0rund.cmd" "%%~fI""
ECHO Running scripts from baseDistUpdateScripts...
FOR /R "%baseDistUpdateScripts%" %%I IN (".Distributives_Update_Run.All.*" ".Distributives_Update_Run.Office.*") DO START /B %comspec% /C ""%~dp0rund.cmd" "%%~fI""
